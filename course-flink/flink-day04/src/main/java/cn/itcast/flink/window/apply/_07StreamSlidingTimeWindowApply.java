 ...
 */
public class _07StreamSlidingTimeWindowApply {
 ...
 */
        ...
        SingleOutputStreamOperator<Tuple2<String, Integer>> resultDStream = mapDataStream
                .keyBy(0)
                ...
                .apply(new WindowFunction<Tuple2<String, Integer>, Tuple2<String, Integer>, Tuple, TimeWindow>() {
                    ...
                    public void apply(Tuple tuple,
                        ...
                        out.collect(Tuple2.of(output, Integer.valueOf(count)));
                    }
                });
        ...
        // 5. 触发执行-execute
        env.execute(_07StreamSlidingTimeWindowApply.class.getSimpleName());
    }
